...
struct vsf_session
{
  ...
  struct vsf_sysutil_sockaddr* E_OPAQUE p_local_addr; /**DSU xfgen */
  struct vsf_sysutil_sockaddr* E_OPAQUE p_remote_addr; /**DSU xfgen */
  char* p_control_line_buf;

  /* Details of the data connection */
  int pasv_listen_fd;
  struct vsf_sysutil_sockaddr* E_OPAQUE p_port_sockaddr; /**DSU xfgen */
  int data_fd;
  int data_progress;
  ...
  int control_use_ssl;
  int data_use_ssl;
  void* E_OPAQUE p_ssl_ctx; /**DSU xfgen */
  void* E_OPAQUE p_control_ssl; /**DSU xfgen */
  void* E_OPAQUE p_data_ssl; /**DSU xfgen */
