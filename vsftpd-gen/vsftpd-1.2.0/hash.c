...
struct hash_node
{
  void E_T(@k) * p_key; /**DSU xfgen */
  void E_T(@v) * p_value; /**DSU xfgen */
  struct hash_node E_G(@k, @v) * p_prev; /**DSU xfgen */
  struct hash_node E_G(@k, @v) * p_next; /**DSU xfgen */
...
struct hash
{
  ...
  struct hash_node E_G(@k, @v) ** E_PTRARRAY(self.buckets) p_nodes; /**DSU xfgen */ /**DSU xfgen */
} E_GENERIC(@k, @v); /**DSU xfgen */
