...
handle_pasv(struct vsf_session* p_sess)
{
  ...
  static struct vsf_sysutil_sockaddr* s_p_sockaddr E_MANUAL_MIGRATE; /**DSU data */
...
handle_retr(struct vsf_session* p_sess)
{
  ...
  static struct vsf_sysutil_statbuf* s_p_statbuf E_MANUAL_MIGRATE; /**DSU data */
...
handle_dir_common(struct vsf_session* p_sess, int full_details)
{
  ...
  static struct vsf_sysutil_statbuf* s_p_dirstat E_MANUAL_MIGRATE; /**DSU data */
  int remote_fd;
...
{
  static struct vsf_sysutil_statbuf* p_statbuf E_MANUAL_MIGRATE; /**DSU data */
  int retval;
  /* Clear old value */
